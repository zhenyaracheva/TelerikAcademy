namespace Cars.Tests.JustMock
{
    ...
    public class CarsControllerTests
    {
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void SortByYearShouldThrowArgumentExceptionWhenNullInput()
        {
            var cars = (IList<Car>)this.GetModel(() => this.controller.Sort(null));
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void SortByYearShouldThrowArgumentExceptionWhenWrongInput()
        {
            var cars = (IList<Car>)this.GetModel(() => this.controller.Sort("2005"));
        }

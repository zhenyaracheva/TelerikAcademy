namespace SolarSystem
{
    ...
    internal class OrbitsCalculator : INotifyPropertyChanged
    {
        ...
        private const int EarthRotationDegrees = 360;
        ...
        {
            this.EarthRotationAngle = OrbitsCalculator.EarthRotationDegrees * this.Days / EarthRotationPeriod;
            this.Update("EarthRotationAngle");
        }

        private void SunRotation()
        {
            this.SunRotationAngle = OrbitsCalculator.EarthRotationDegrees * this.Days / SunRotationPeriod;
